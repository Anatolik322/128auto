                ...
                <div className="category__card__container">
                    <div className="category__product__card">
                        ...
                        <div className="show__more__action">
                            <Button variant='outlined' sx={[{ width: '200px', height: '50px', borderRadius: '20px', fontWeight: '700', backgroundColor: '#f28a0a', borderColor: '#f28a0a', color: 'black' }, { '&:hover': { borderColor: '#f28a0a', backgroundColor: "none" } }]}>Show more</Button>
                        </div>
                    </div>
                </div>
            </div>
