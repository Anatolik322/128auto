    ...
    return (
        <div className="wishcard">
            ...
            <div className="add__to__cart">
                <Button variant='outlined' onClick={handelAddToCart} sx={[{ '&:hover': { backgroundColor: '#f28a0a', borderColor: '#f28a0a', color: 'black' }, borderColor: 'black', backgroundColor: "black", color: "#f28a0a" }]}>Add to cart</Button>
            </div>
        </div>
    );
}
